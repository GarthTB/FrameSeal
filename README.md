...
`FrameSeal` 是一个 Windows 单平台的 GUI 应用，
用于向图像四周添加仿胶片外观的纯色边框，
...
[![平台 Windows x64](https://img.shields.io/badge/平台-Windows%20x64-yellow.svg)](https://github.com/GarthTB/FrameSeal)
[![版本 1.2.4](https://img.shields.io/badge/版本-1.2.4-brightgreen)](https://github.com/GarthTB/FrameSeal/releases/latest)
